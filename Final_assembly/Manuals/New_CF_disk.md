...
**With 'c0' command, CFMon is copied to track 0.**
**With 'c1' command, ZZMon is copied to track 1.**

## Load files in CF Bootstrap mode
**Enable the CF bootstrap mode and reset.**
